...
<map name="page-20">
    ...
    <?php $id = 200 + $i?>
            <area shape="rect" class="tooltipLink" coords=<?php echo $array[19]["silhouettes"][$i]["coordinates"]?> data-coords=<?php echo $array[19]["silhouettes"][$i]["coordinates"]?> data-id=<?php echo $id ?> data-tooltip="<?php print $array[4]["silhouettes"][$i]["url"] ?>">
    <?php endfor; ?>
</map>