...
<map name="page-15">
    ...
    <?php $id = 150 + $i?>
            <area shape="rect" class="tooltipLink" coords=<?php echo $array[14]["silhouettes"][$i]["coordinates"]?> data-coords=<?php echo $array[14]["silhouettes"][$i]["coordinates"]?> data-id=<?php echo $id ?> data-tooltip="<?php print $array[4]["silhouettes"][$i]["url"] ?>">
    <?php endfor; ?>
</map>